...
Hands=mphands.Hands(min_detection_confidence=0.675)  #min_detection_confidence=0.5  (optional parameter)
...
while True:
    ...
    if results.multi_hand_landmarks:
        ...
        print(status)
        cv2.putText(frame,"Status:"+status,(10,60),cv2.FONT_HERSHEY_PLAIN,2,(255,100,0),2)
